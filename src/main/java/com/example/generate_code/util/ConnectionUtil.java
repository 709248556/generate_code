...
public class ConnectionUtil {
    ...
    */
    public Connection getConnection() {
        try {
            conn = DriverManager.getConnection(environment.getProperty("url"), environment.getProperty("mysqlusername"), environment.getProperty("password"));
     ...
     * @return
     */
    public List<String> getIndexInfo(String tableName) {
