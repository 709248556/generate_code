...
public class DataUtil {
    ...
    private static final String URL = "jdbc:mysql://10.252.1.187:3306/eshopdb?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8&useSSL=false";
    private static final String USERNAME = "eshopuser";
    private static final String PASSWORD = "eshopuser!Q2w3e4r";
