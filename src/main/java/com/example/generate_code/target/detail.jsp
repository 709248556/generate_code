...
<body>
<form id="FormSumbit" action="${ctx}/garbage/addSub" method="post" class="form-horizontal">
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="id"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="id" id="id" placeholder="请输入" value="${garbage.id}" disabled="disabled"/>
        </div>
    </div>
        <label class="col-sm-2 control-label" for="parentId"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="parentId" id="parentId" placeholder="请输入" value="${garbage.parentId}" disabled="disabled"/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="name"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="name" id="name" placeholder="请输入" value="${garbage.name}" disabled="disabled"/>
        </div>
    </div>
        <label class="col-sm-2 control-label" for="price"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="price" id="price" placeholder="请输入" value="${garbage.price}" disabled="disabled"/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="lastTime"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="lastTime" id="lastTime" placeholder="请输入" value="${garbage.lastTime}" disabled="disabled"/>
        </div>
    </div>
