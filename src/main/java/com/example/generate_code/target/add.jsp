...
<form id="FormSumbit" action="${ctx}/garbage/addSub" method="post" class="form-horizontal">
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="id" id="id" placeholder="请输入"/>
        </div>
    </div>
        <label class="col-sm-2 control-label" for="parentId"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="parentId" id="parentId" placeholder="请输入"/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="name"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="name" id="name" placeholder="请输入"/>
        </div>
    </div>
        <label class="col-sm-2 control-label" for="price"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="price" id="price" placeholder="请输入"/>
        </div>
    </div>
    <div class="form-group form-group-sm">
