...
<form id="FormSumbit" action="${ctx}/customer/address/addSub" method="post" class="form-horizontal">
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="custAddrId" id="custAddrId" placeholder="请输入" value="${customerAddress.custAddrId}"/>
        </div>
        <label class="col-sm-2 control-label" for="customerId"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="customerId" id="customerId" placeholder="请输入" value="${customerAddress.customerId}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="contactsName"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="contactsName" id="contactsName" placeholder="请输入" value="${customerAddress.contactsName}"/>
        </div>
        <label class="col-sm-2 control-label" for="contactsPhone"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="contactsPhone" id="contactsPhone" placeholder="请输入" value="${customerAddress.contactsPhone}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="contactsGender"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="contactsGender" id="contactsGender" placeholder="请输入" value="${customerAddress.contactsGender}"/>
        </div>
        <label class="col-sm-2 control-label" for="provinceCode"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="provinceCode" id="provinceCode" placeholder="请输入" value="${customerAddress.provinceCode}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="provinceName"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="provinceName" id="provinceName" placeholder="请输入" value="${customerAddress.provinceName}"/>
        </div>
        <label class="col-sm-2 control-label" for="cityCode"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="cityCode" id="cityCode" placeholder="请输入" value="${customerAddress.cityCode}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="cityName"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="cityName" id="cityName" placeholder="请输入" value="${customerAddress.cityName}"/>
        </div>
        <label class="col-sm-2 control-label" for="districtCode"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="districtCode" id="districtCode" placeholder="请输入" value="${customerAddress.districtCode}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="districtName"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="districtName" id="districtName" placeholder="请输入" value="${customerAddress.districtName}"/>
        </div>
        <label class="col-sm-2 control-label" for="streetId"><span class="required">*</span>街道编号</label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="streetId" id="streetId" placeholder="请输入街道编号" value="${customerAddress.streetId}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="streetName"><span class="required">*</span>街道名称</label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="streetName" id="streetName" placeholder="请输入街道名称" value="${customerAddress.streetName}"/>
        </div>
        <label class="col-sm-2 control-label" for="communityId"><span class="required">*</span>所属社区</label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="communityId" id="communityId" placeholder="请输入所属社区" value="${customerAddress.communityId}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="address"><span class="required">*</span>详细地址</label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="address" id="address" placeholder="请输入详细地址" value="${customerAddress.address}"/>
        </div>
        <label class="col-sm-2 control-label" for="isDefault"><span class="required">*</span>默认地址</label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="isDefault" id="isDefault" placeholder="请输入默认地址" value="${customerAddress.isDefault}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="createTime"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="createTime" id="createTime" placeholder="请输入" value="${customerAddress.createTime}"/>
        </div>
        <label class="col-sm-2 control-label" for="lastTime"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="lastTime" id="lastTime" placeholder="请输入" value="${customerAddress.lastTime}/>
        </div>
    </div>
    <div class="form-group form-group-sm">
		<label class="col-sm-2 control-label" for="extField1"><span class="required">*</span></label>
        <div class="col-sm-3">
            <input type="text" class="form-control required" name="extField1" id="extField1" placeholder="请输入" value="${customerAddress.extField1}"/>
        </div>
