...
<#list baseResultMapVoList as baseResultMapVo >
	 ...
	 */
		<#if inputsMap[key]>
	<#if baseResultMapVo.DTOType =="String">@NotEmpty(message = "${baseResultMapVo.columnComment}")
	<#elseif  baseResultMapVo.DTOType =="Long">@NotNull(message = "${baseResultMapVo.columnComment}")
	<#elseif  baseResultMapVo.DTOType =="Integer">@NotNull(message = "${baseResultMapVo.columnComment}")
	</#if>
		</#if>
